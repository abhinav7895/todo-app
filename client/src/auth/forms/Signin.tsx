  ...
  return (
    <div className='w-full max-w-md px-4 py-10   rounded-lg  border border-gray-500'>
      ...
      <form onSubmit={handleSubmit} className=' flex flex-col gap-3 mt-6'>
        ...
        {email.error && <span className='text-red-500 text-sm'>{email.error}</span>}
        <div className='flex flex-col gap-1'>
        ...
        <button aria-label='login to your account' disabled={loader} type="submit" className="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 flex justify-center items-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 disabled:bg-blue-500">
